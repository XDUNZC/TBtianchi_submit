...
class Reader:
    def __init__(self,
        ...
        # 读取商品类数
        _, self.img_dir_list, _ = os.walk(self.img_path)  # 商品标签名
        self.img_dir_path_list = []  # 商品标签文件地址
        self.img_file_in_dir_path_dict = {}  # 根据商品标签索引商品图片地址
        for img_dir in self.img_dir_list:
            img_dir_path = os.path.join(self.img_path, img_dir)
            ...
            self.img_file_in_dir_path_dict[img_dir] = img_file_in_dir_path_list
